...
* used to fail in certain scenarios where too many threads tried to get the instance of the
*  singleton class simultaneously. So Bill Pugh came up with a different approach to create
*  the singleton class using an inner static helper class. Here is an example of the Bill Pugh
